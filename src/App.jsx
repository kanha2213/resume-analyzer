...
// =============================================
// CONFIG — Replace with your actual Lambda API URL
// =============================================
const API_URL = "https://lnxm4j4lh7.execute-api.eu-north-1.amazonaws.com/analyze-resume"; // e.g. https://abc123.execute-api.us-east-1.amazonaws.com/prod/analyze-resume
...
export default function App() {
  ...
  // Cycle loading messages for visual feedback
  useEffect(() => {
    if (!loading) return;
    let i = 0;
  ...
  // Pre-warm Lambda on mount (invisible to user)
  useEffect(() => {
...
function Results({ data, onReset }) {
  // Handle raw_analysis fallback (if Claude didn't return JSON)
